...
data='/home/io/Dropbox/For_Eros/SNR_rawdata_examples/Shoulder16ch_small_SNRRawData/meas_MID254_SNR_Sag_BW300_FID13612.dat';
noiz='/home/io/Dropbox/For_Eros/SNR_rawdata_examples/Shoulder16ch_small_SNRRawData/meas_MID250_SNR_Noi_BW300_FID13608.dat';
a=SIEMENSImporter;
a.setSignalFileName(data);
a.readSignalRawData()
a.setNoiseFileName(noiz);
a.readNoiseRawData('avg');
image_obj= a.getNoiseRawData();
